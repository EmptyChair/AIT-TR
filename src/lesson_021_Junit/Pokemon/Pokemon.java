...
public class Pokemon {
    ...
    public Pokemon(String name, String pokemonType, int hp, int currentHp, int attack, int defence, int speed, String specialAttack, String specialDefence, boolean asleep) {
        setName(name);
    ...
    public PokemonTeam attack(PokemonTeam team) {
        int damage;
