package Temp_Hold.lesson_017_Incapsulation.CurrencyConverter;
...
public class CurrencyConvCli {
    public static void main(String[] args) {
        ...
        //CurrencyConverter cc0 = new CurrencyConverter();
        ...
        do {
            ...
            //shutdown if origC returns -1 aka the currency wasn't found
            if (origC==-1) {
                System.exit(-1);
            }
