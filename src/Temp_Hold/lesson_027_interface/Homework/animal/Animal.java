package Temp_Hold.lesson_027_interface.Homework.animal;

import Temp_Hold.lesson_027_interface.Homework.mobile.MobileTheft;
import Temp_Hold.lesson_027_interface.Homework.mobile.MobileThief;

public class Animal extends MobileThief {
    ...
    public void acquireMobile() {
        System.out.println("The animal swipes your mobile!");
    }
}
